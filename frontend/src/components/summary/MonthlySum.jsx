...
import { ChevronLeft, ChevronRight, Download, Calendar, Wallet, Tag, TrendingUp, BarChart3, Users, Target } from 'lucide-react';
...
const MonthlySum = () => {
  ...
  const avgDailySpend = totalSpent / 30; // Monthly average per day
  ...
  const monthlyBudget = 15000; // Sample budget
