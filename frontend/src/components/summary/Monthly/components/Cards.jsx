...
import { Wallet, Tag, TrendingUp, BarChart3, Users, Target } from 'lucide-react';
import dataService from '../services/dataService';
import chartService from '../services/chartService';

const Cards = ({ expenseData, currentMonth, isLoading = false }) => {
  const insights = dataService.getMonthlyInsights(expenseData);
  const daysInMonth = dataService.getDaysInMonth(currentMonth);
  ...
  const cardData = [
    ...
    },
    {
      ...
      value: chartService.formatCurrency(insights.highestExpense),
      subtitle: 'Single category',
      icon: Users,
      iconBg: '#FFEBEE',
      iconColor: '#E74C3C'
    },
    {
      title: 'Budget Used',
      value: chartService.formatPercentage(insights.budgetUsage),
      subtitle: `of Rs. ${chartService.formatCurrency(insights.budget)}`,
      icon: Target,
      iconBg: '#E8F6F3',
      iconColor: '#1ABC9C'
    }
